...
section data_level18 [compress=zx7]
section data_level19 [compress=zx7]
section data_level20 [compress=zx7]
...
section data_pvpLevel5 [compress=zx7]
section data_pvpLevel6 [compress=zx7]
